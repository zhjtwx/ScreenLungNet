...
def resize_pos_embed(pos_embed,
    ...
    # print(src_weight.size(), src_weight.reshape(1, src_d, src_h, src_w, C).size())


    src_weight = src_weight.reshape(1, src_d, src_h, src_w, C).permute(0, 4, 1, 2, 3)

    dst_weight = F.interpolate(
        src_weight, size=dst_shape, align_corners=False, mode=mode)
    print(dst_weight.size())
